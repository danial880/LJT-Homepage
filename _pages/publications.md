...
- **"On the Universal Truthfulness Hyperplane Inside LLMs"** (2024) - published at EMNLP 2024

### Co-Authored Publications
- **"In-Context Sharpness as Alerts: An Inner Representation Perspective for Hallucination Mitigation"** (2024) - ICML 2024
- **"C-Eval: A Multi-Level Multi-Hiscilpline Chinese Evaluation Suite for Foundation Models"** (2023) - NeurIPS 2023
- **"Composing Parameter-Efficient Modules with Arithmetic Operations"** (2023) - NeurIPS 2023

For more detailed information, please refer to my [Google Scholar profile](https://scholar.google.com/citations?hl=en&user=tbK9jl4AAAAJ&view_op=list_works&sortby=pubdate).
